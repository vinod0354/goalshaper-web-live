...
export class CalendarComponent implements OnInit {
  ...
  constructor(private modalService: BsModalService, private enterpriseService: EnterpriseService, private globals: GlobalService, private datapipe:DatePipe, public pubsubSvc: NgxPubSubService) { 
    this.countChunks();
  }
